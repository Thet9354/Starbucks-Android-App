...
public class TakeAway extends Fragment {
    ...
    private TextView txtView_pickUp, txtView_pickUpAddress, txtView_addMore, txtView_orderName, txtView_orderDesc, txtView_orderCost,
            ...
            txtView_totalCost, txtView_pickUpTime, txtView_pickUpDate;

    private ImageView imgView_pickUpEdit, imgView_order, imgView_bookMarked, imgView_paymentCard, imgView_changeCard;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_take_away, container, false);
    ...
    private void findViews(View v) {
        ...
        //TextView
        txtView_pickUp = v.findViewById(R.id.txtView_pickUp);
        txtView_pickUpAddress = v.findViewById(R.id.txtView_pickUpAddress);
        ...
        txtView_pickUpTime = v.findViewById(R.id.txtView_pickUpTime);
        txtView_pickUpDate = v.findViewById(R.id.txtView_pickUpDate);

        //ImageView
        imgView_pickUpEdit = v.findViewById(R.id.imgView_pickUpEdit);
